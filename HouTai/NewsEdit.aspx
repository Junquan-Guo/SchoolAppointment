<%@ Page Title="" Language="C#" MasterPageFile="~/HouTai/ManageMasterPage.master" AutoEventWireup="true" CodeFile="NewsEdit.aspx.cs" Inherits="HouTai_NewsEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="d_Confirm_Order_style">
        ...
        <asp:Button ID="Button1" runat="server" Text="取消" CssClass="btn btn-primary" OnClick="Button1_Click" />
        <asp:Button ID="Button3" runat="server" Text="修改" CssClass="btn btn-success" OnClientClick="return confirm('确认修改?')" OnClick="Button3_Click" />
