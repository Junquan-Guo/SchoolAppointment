<%@ Page Title="" Language="C#" MasterPageFile="~/HouTai/ManageMasterPage.master" AutoEventWireup="true" CodeFile="UserList.aspx.cs" Inherits="HouTai_UserAll" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="search_style">
        <ul class="search_content clearfix">
            ...
            <li style="width: 90px;">
                <asp:Button ID="Button1" runat="server" Text="查询" CssClass="btn_search " OnClick="Button6_Click" />
            </li>
        </ul>
    </div>
    <div class="border clearfix">
        <span class="l_f">
            <asp:Button ID="Button2" runat="server" Text="黑名单" CssClass="btn btn-warning" />
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="userid" DataSourceID="SqlDataSource1" AllowPaging="True" OnPageIndexChanged="GridView1_PageIndexChanged" BorderColor="#E4E3E0" Width="100%" PageSize="7">
            <Columns>
                ...
                <asp:TemplateField ShowHeader="False" HeaderText="编辑操作">
                    ...
                    <ItemTemplate>
                        <asp:LinkButton ID="LinkButton1" runat="server" class="btn btn-success links_edit" OnClick="LinkButton1_Click" ToolTip='<%# Bind("userid") %>'><i class="fa fa-edit"></i>编辑</asp:LinkButton>
                    </ItemTemplate>
                    <HeaderStyle Width="5%" />
                </asp:TemplateField>
            </Columns>
