...
{
    //获取配置连接信息
    public static string connstr = ConfigurationManager.ConnectionStrings["Fitness312ConnectionString"].ToString();
    ...
    protected void btnlogin_Click(object sender, EventArgs e)
    {
        ...
        {
            //写对数据库的操作语句
            string str = "select * from manage where managename='" + txtmanagename.Text + "' and password='" + txtmanagepassword.Text + "'";
            ...
            if (reader.HasRows)
            {
                ...
                Response.Redirect("~/HouTai/ManageDefault.aspx");
            }
            else
